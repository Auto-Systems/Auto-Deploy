...
export type ManagedNodeQuery = (
  ...
  & { managedNode: (
    ...
    & { logs: Array<(
      { __typename?: 'Log' }
      & Pick<Types.Log, 'id' | 'createdAt'>
      & { commandResults: Array<(
        { __typename?: 'CommandResult' }
        & Pick<Types.CommandResult, 'command' | 'result'>
      )> }
    )> }
  ) }
);
